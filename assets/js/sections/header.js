(function(){
  ...
  document.getElementById('site-header').innerHTML=`<nav class="navbar container" aria-label="التنقل الرئيسي">
    <a class="brand" href="#home" aria-label="منصة عزنا بطموحنا - الرئيسية"><span class="brand-mark"><img src="assets/images/logo-mark.png" alt="" width="46" height="46"></span><span><b>منصة عزنا بطموحنا</b><small>خدمات المعلمين والمعلمات</small></span></a>
